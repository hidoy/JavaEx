...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		// 역참조(검색)
		// 객체의 인덱스 조회
		System.out.println("v.indenxOf(5): " + v.indexOf(5));

		System.out.println("v.indenxOf(20): " + v.indexOf(20));
		// 없는 객체: -1
		
		// 객체 포함 여부 : .contains
		System.out.println(":contains(7): " + v.contains(7));	// true
		System.out.println(":contains(20): " + v.contains(20));	// flase

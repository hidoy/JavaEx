...
public class WrapperEx {
	public static void main(String[] args) {
		...
		// 주의: 전달되는 파라미터의 문자열의 형태가 해당하는 기본형의 형태를 갖쳐야 한다
		...
		// prase 계열 메서드 : 문자열 이용, 특정 타입으로 변환, 다른 형태로 출력
		System.out.println(Integer.parseInt("-123")); 	// 문자열 -> 상수
		System.out.println(Integer.parseInt("ff",16)); // 16진수 10-> 정수
		...
		;
		System.out.println(Integer.bitCount(28)); // 2지누에서 1의 개수

...
public class StringClassEx {
	...
	private static void usefulMethods() {
		...
		System.out.println("toLowerCase: " + str.toLowerCase()); // 전부 소문자로 전환
		...
		// 공백 문자를 기준으로 문자열을 분리 -> 문자열 배열로 변환
